...
export default class MyApp extends JetApp {
  constructor(config) {
    ...
    // print the apiServer URL
    console.log("API Server URL: ", defaults.apiServer);
    ...
    session.setApiServer(this.config.apiServer);

    this.use(plugins.User, {
      model: session,
      ping: 3000, // Check the user status every 30 seconds
      afterLogin: "/top/account", // Redirect to preferences after login
