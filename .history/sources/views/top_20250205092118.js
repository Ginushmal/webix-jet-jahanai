...
export default class TopView extends JetView {
  config() {
    ...
    var menu = {
      ...
      data: [
        { value: "Dashboard", id: "account", icon: "wxi-columns" },
        { value: "Dashboard", id: "notification", icon: "wxi-columns" },
        { value: "Dashboard", id: "theme", icon: "wxi-columns" },
        { value: "Dashboard", id: "privacy", icon: "wxi-columns" },
      ],
    };
